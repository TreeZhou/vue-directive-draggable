(function e(t,r){if(typeof exports==="object"&&typeof module==="object")module.exports=r();else if(typeof define==="function"&&define.amd)define([],r);else if(typeof exports==="object")exports["vue-dragging"]=r();else t["vue-dragging"]=r()})(typeof self!=="undefined"?self:this,function(){/******/
...
/******/([
/* 0 */
/***/function(e,t,r){"use strict";var n=r(1);e.exports=n;
/***/},
/* 1 */
...
//子元素都不能选中
n.children.forEach(function(e){if(e.elm&&e.elm.style){e.elm.style.pointerEvents="none"}});var o=r.value.item;var a=r.value.list;var i=t.new(r.value.name);var s=n.key;i.KEY_MAP[s]=o;if(a&&i.List!==a){i.List=a}e.setAttribute("draggable","true");e.setAttribute("drag_name",r.value.name);e.setAttribute("drag_key",s);f.on(e,"dragstart",u);f.on(e,"dragenter",v);f.on(e,"dragover",g);f.on(e,"drag",m);f.on(e,"dragleave",h);f.on(e,"dragend",p);f.on(e,"drop",y);f.on(e,"mousedown",u);f.on(e,"touchstart",u);f.on(e,"touchmove",v);f.on(e,"touchend",p)}function L(e,r,n){var o=t.new(r.value.name);var a=n.key;o.KEY_MAP[a]=undefined;f.off(e,"dragstart",u);f.off(e,"dragenter",v);f.off(e,"dragover",g);f.off(e,"drag",m);f.off(e,"dragleave",h);f.off(e,"dragend",p);f.off(e,"drop",y);f.off(e,"mousedown",u);f.off(e,"touchstart",u);f.off(e,"touchmove",v);f.off(e,"touchend",p)}e.prototype.$dragging=i;e.directive("dragging",{bind:P,update:function e(r,n,o){var a=t.new(n.value.name);var i=n.value.item;var f=n.value.list;var s=o.key;var u=a.KEY_MAP[s];if(i&&u!==i){a.KEY_MAP[s]=i}if(f&&a.List!==f){a.List=f}},unbind:L})};
/***/}
/******/])});